...
public class VehicleListType {
	...
	/**
	 * Gets the list of model class {@link Vehicleinfotype}
	 * 
	 * @return
	 */
	public List<Vehicleinfotype> getVehicles() {
		List<Vehicleinfotype> vehicleList = new ArrayList<Vehicleinfotype>();
		vehicleDetails = getVehicleDetails();
		for (VehicleInfoType vehicleinfotype : vehicleDetails) {
			vehicleList.add(vehicleinfotype.getVehicleInfo());
		}
		return vehicleList;
	}

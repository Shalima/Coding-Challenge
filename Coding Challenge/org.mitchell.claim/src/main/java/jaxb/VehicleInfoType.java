...
@XmlType(name = "VehicleInfoType", propOrder = { "modelYear", "makeDescription", "modelDescription",
		"engineDescription", "exteriorColor", "vin", "licPlate", "licPlateState", "licPlateExpDate",
...
public class VehicleInfoType {
	...
	/**
	 * Converts the JAXB class to the model class Vehicleinfotype
	 * 
	 * @return
	 */
	public Vehicleinfotype getVehicleInfo() {
		XMLGregorianCalendar date = this.licPlateExpDate;
		Date newDate = (date == null) ? null : date.toGregorianCalendar().getTime();
		return new Vehicleinfotype(this.vin, null, this.modelYear, this.makeDescription, this.modelDescription,
				this.engineDescription, this.exteriorColor, this.licPlate, this.licPlateState, this.damageDescription,
				newDate, this.mileage);
	}
